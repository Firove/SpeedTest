...
public class TestCtrl1 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        maxSpeedIndex = UnityEngine.Random.Range(0, 2.5f);
    ...
    public void Click0()
    {
        ...
        string pathselect = Application.dataPath + "/excel1/selectSpeedTest.txt";//选择速度百分值
        string pathSpeedFact = Application.dataPath + "/excel1/speedFactTest.txt";//实际速度原值
        string pathSpeedSelectOri = Application.dataPath + "/excel1/speedSelectOri.txt";//选择速度原值
    ...
    public void Click1()
    {
        ...
        {
            maxSpeedIndex = UnityEngine.Random.Range(0f, 2.5f);

        }
        else
        {
            maxSpeedIndex = UnityEngine.Random.Range(2.5f, 3.0f);
